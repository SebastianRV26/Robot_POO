 ...
 * @author Sebas
 */
public class Socks extends Article{
    private String type;

    public Socks(int ID, int price, String name, String color, int quantity, String type) {
    ...
    public boolean reserveArticleWithCash (Article article, int cant, int amount) //reservar artículo        
    {
        ...
        Socks art = new Socks(this.getID(), this.getPrice(), this.getName(), this.getColor(), this.getQuantity(), this.getType());
        articles.add(art);
        }
