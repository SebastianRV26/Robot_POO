...
public class Cap extends Article{
    ...
    public Cap(int ID, int price, String name, String color, int quantity, String type) {
    ...
    public boolean reserveArticleWithCash (Article article, int cant, int amount) //reservar artículo        
    {
        ...
        Cap art = new Cap(this.getID(), this.getPrice(), this.getName(), this.getColor(), this.getQuantity(), this.getType());
        articles.add(art);
        }
