 ...
 * @author Sebas
 */
public class Pant extends Article implements Discount{
    private String WorkManShip;
    double discount = 0.15;

    public Pant(int ID, int price, String name, String color, int quantity, String WorkManShip) {
    ...
    public boolean reserveArticleWithCash (Article article, int cant, int amount) //reservar artículo        
    {
        ...
        Pant art = new Pant(this.getID(), this.getPrice(), this.getName(), this.getColor(), this.getQuantity(), this.getWorkManShip());
        articles.add(art);
        }
