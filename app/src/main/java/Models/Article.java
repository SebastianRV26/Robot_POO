...
public abstract class Article {
    ...
    public boolean payWithCash(Article article, int cant, int amount){      
        double price;
        ...
        if (price>amount){ //no tiene suficiente plata
            ...
            int cambio = amount - article.getPrice()*cant;
    ...
    public boolean payWithCard(Article article, int cant, int IDCard, String nameClient, int cedula){ //número de targeta               
        double price;
        if (article instanceof Dress){
            price = ((Dress) article).makeDiscount()*cant;
        }else if(article instanceof Pant){
